...
if("TRUE" STREQUAL "TRUE")
  set(dji_sdk_SOURCE_PREFIX /home/dji/obstacle_avoidance/control/discontinuity-without_outliers-binary-multiframe/src/dji_sdk)
  set(dji_sdk_DEVEL_PREFIX /home/dji/obstacle_avoidance/control/discontinuity-without_outliers-binary-multiframe/devel)
  set(dji_sdk_INSTALL_PREFIX "")
  set(dji_sdk_PREFIX ${dji_sdk_DEVEL_PREFIX})
else()
  set(dji_sdk_SOURCE_PREFIX "")
  set(dji_sdk_DEVEL_PREFIX "")
  set(dji_sdk_INSTALL_PREFIX /home/dji/obstacle_avoidance/control/discontinuity-without_outliers-binary-multiframe/install)
...
if(NOT "/home/dji/obstacle_avoidance/control/discontinuity-without_outliers-binary-multiframe/src/dji_sdk/include " STREQUAL " ")
  set(dji_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/home/dji/obstacle_avoidance/control/discontinuity-without_outliers-binary-multiframe/src/dji_sdk/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'iarc <iarc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dji/obstacle_avoidance/control/discontinuity-without_outliers-binary-multiframe/src/dji_sdk/${idir}'.  Ask the maintainer 'iarc <iarc@todo.todo>' to fix it.")
    endif()
    _list_append_unique(dji_sdk_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "dji_sdk")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dji/obstacle_avoidance/control/discontinuity-without_outliers-binary-multiframe/devel/lib;/opt/ros/indigo/lib)
